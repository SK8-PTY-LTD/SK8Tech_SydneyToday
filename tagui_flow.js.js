...
var flow_path = '/Users/XujieSong/Desktop/SK8Tech_SydneyToday';

casper.start('http://www.sydneytoday.com/login?destination=/user/myposts', function() {
techo('http://www.sydneytoday.com/login?destination=/user/myposts' + ' - ' + this.getTitle() + '\n');});

casper.then(function() {
{techo('click .tab-pane.active #tel');
casper.waitFor(function check() {return check_tx('.tab-pane.active #tel');},
function then() {this.click(tx('.tab-pane.active #tel'));},
function timeout() {this.echo('ERROR - cannot find .tab-pane.active #tel').exit();});}});

casper.then(function() {
{techo('enter .tab-pane.active #tel as 449843149');
casper.waitFor(function check() {return check_tx('.tab-pane.active #tel');},
function then() {this.sendKeys(tx('.tab-pane.active #tel'),'449843149');},
function timeout() {this.echo('ERROR - cannot find .tab-pane.active #tel').exit();});}});

casper.then(function() {
{techo('click .tab-pane.active #password');
casper.waitFor(function check() {return check_tx('.tab-pane.active #password');},
function then() {this.click(tx('.tab-pane.active #password'));},
function timeout() {this.echo('ERROR - cannot find .tab-pane.active #password').exit();});}});

casper.then(function() {
{techo('enter .tab-pane.active #password as JmY9HQ#V!fn1tyxj');
casper.waitFor(function check() {return check_tx('.tab-pane.active #password');},
function then() {this.sendKeys(tx('.tab-pane.active #password'),'JmY9HQ#V!fn1tyxj');},
function timeout() {this.echo('ERROR - cannot find .tab-pane.active #password').exit();});}});

casper.then(function() {
{techo('click .tab-pane.active #user-login');
casper.waitFor(function check() {return check_tx('.tab-pane.active #user-login');},
function then() {this.click(tx('.tab-pane.active #user-login'));},
function timeout() {this.echo('ERROR - cannot find .tab-pane.active #user-login').exit();});}});

casper.then(function() {
{techo('click .row.account-itemcell:nth-child(1) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie');
casper.waitFor(function check() {return check_tx('.row.account-itemcell:nth-child(1) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie');},
function then() {this.click(tx('.row.account-itemcell:nth-child(1) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie'));},
function timeout() {this.echo('ERROR - cannot find .row.account-itemcell:nth-child(1) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie').exit();});}});

casper.then(function() {
{techo('click .row.account-itemcell:nth-child(3) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie');
casper.waitFor(function check() {return check_tx('.row.account-itemcell:nth-child(3) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie');},
function then() {this.click(tx('.row.account-itemcell:nth-child(3) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie'));},
function timeout() {this.echo('ERROR - cannot find .row.account-itemcell:nth-child(3) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie').exit();});}});

casper.then(function() {
{techo('click .row.account-itemcell:nth-child(5) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie');
casper.waitFor(function check() {return check_tx('.row.account-itemcell:nth-child(5) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie');},
function then() {this.click(tx('.row.account-itemcell:nth-child(5) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie'));},
function timeout() {this.echo('ERROR - cannot find .row.account-itemcell:nth-child(5) .btn.btn-default.btn-sm.account-comment-item-edit__ifdisable.dingtie').exit();});}});

casper.then(function() {
{techo('click //a[contains(text(),"退出") or contains("http://www.sydneytoday.com/globals/logout",@href)]');
casper.waitFor(function check() {return check_tx('//a[contains(text(),"退出") or contains("http://www.sydneytoday.com/globals/logout",@href)]');},
function then() {this.click(tx('//a[contains(text(),"退出") or contains("http://www.sydneytoday.com/globals/logout",@href)]'));},
function timeout() {this.echo('ERROR - cannot find //a[contains(text(),"退出") or contains("http://www.sydneytoday.com/globals/logout",@href)]').exit();});}});
